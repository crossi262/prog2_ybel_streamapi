...
public class Main {
    ...
    return studentList.stream()
            .filter(Student::isIFM) // Filtert nur Studenten im Informatik-Studiengang
            .map(Student::cps) // Wandelt jeden Studenten in seine ECTS-Punkte um
            .collect(Collectors.toSet()); // Sammelt die ECTS-Punkte in einem Set
    }
